...
/**
 * Helper to unwrap move() Result for tests that expect Code[] directly
 */
function moveAndUnwrap(
  files: FileInput[],
  from: PositionSelector,
  to: PositionSelector,
  mode: Move
) {
  const result = move(files, from, to, mode);
  if (isErr(result)) {
...
describe('Basic Move Integration Tests', () => {
  ...
  describe('Move.Before Integration', () => {
    it('should move footer before header using position selectors', () => {
      ...
      const codes = moveAndUnwrap(files, from, to, Move.Before);
  ...
  describe('Move.After Integration', () => {
    it('should move header after footer using position selectors', () => {
      ...
      const codes = moveAndUnwrap(files, from, to, Move.After);
  ...
  describe('analyze() API', () => {
    ...
    it('should return Err for invalid moves', () => {
      const files = [createFileInput('test.tsx', simpleJSXCode)];
  ...
  describe('Error Cases', () => {
    it('should throw error for invalid source file', () => {
      ...
      expect(() => moveAndUnwrap(files, from, to, Move.Before)).toThrow();
    });
...
`;
    ...
    it('should handle empty files array', () => {
      ...
      expect(() => moveAndUnwrap([], from, to, Move.Before)).toThrow();
    });
  });
