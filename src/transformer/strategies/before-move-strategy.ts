/**
 * Before Move Strategy
 *
 * Implements Move.Before operation - insertBefore sibling semantics.
...
/**
 * Strategy for Move.Before operations
 */
export class BeforeMoveStrategy implements IMoveStrategy {
  /**
   * Execute Move.Before operation
   *
   * Inserts the source element as the previous sibling of the target element.
   */
  execute(
