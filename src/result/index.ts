 ...
 * instead of requiring a custom default value. This is particularly useful in
 * test contexts where you want to check if a Result is Ok and get its value,
 * or get null if it's Err.
 *
 * @typeParam T - The type of the success value
 * @typeParam E - The type of the error value
 * @param result - The Result to unwrap
 * @returns The Ok value or null if Result is Err
 *
 * @example
 * ```typescript
 * // Ok case - returns value
 ...
 * ```
 */
export { unwrapResult } from './helpers.js';
